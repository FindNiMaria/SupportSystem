...
{
    public class EmailTicketService : IEmailTicketService
    {
        private readonly EmailSettings _settings;
        private readonly ApplicationDbContext _context;
        private readonly IConfiguration _configuration;

        public EmailTicketService(EmailSettings settings, ApplicationDbContext context,IConfiguration configuration)
        {
            _settings = settings;
            _context = context;
        ...
        public async Task ImportarEmailsComoTicketsAsync()
        {
